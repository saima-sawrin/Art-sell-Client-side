...
const Banner = () => {
  ...
  <div id="slide1" className="carousel-item relative w-full text-white  ">
    ...
    <div className=" absolute flex flex-col-2   transform translate-y-1/2 left-5 right-5 top-1/4 ">
      <div className='slide-right'>
        <h2 className=' uppercase lg:mb-2 font-semibold  lg:text-6xl '>FEMME <span className='text-primary lg:text-6xl'>FATALE</span> </h2>
       
        <h3 className='text-gray-400 lg:mb-5 decoration-slice'>BODY ART</h3>
  ...
  <div id="slide2" className="carousel-item relative w-full">
    ...
    <div className="absolute flex justify-around  transform translate-y-1/2 left-5 right-5 top-1/4 ">
      <div className='slide-right'>
  ...
  <div id="slide3" className="carousel-item relative w-full">
    <img src={bg3} className="w-full opacity-50 " />
    <div className="absolute flex justify-around  transform translate-y-1/2 left-5 right-5 top-1/4 ">
      <div className='slide-right'>
